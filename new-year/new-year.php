	...
	function greetings_newyear()
	{
		...
		if($new_radio_active=="new_active")
		{
			if($date==true)
			{
				...
				wp_enqueue_script('new_myjs2', $path.'js/my_newyear.js');
						...
						{ echo '
							<div id="frame-wrapper">
								...
								<div class="baloon-prt-effect">
									<div class="baloon baloon_tc01">
										<img src="'.$path.'img/goldan-baloon.png"/>
									</div>						
									<div class="baloon baloon_tc">
										<img src="'.$path.'img/goldan-baloon.png"/>
									</div>						
								</div>
								<div class="star-prt-effect">						
									<div class="star_tc">
										<img src="'.$path.'img/snow-flex-big.png"/>
									</div>
									<div class="star_tc01">
										<img src="'.$path.'img/big_star.png"/>
									</div>
								</div>				
									...
									<div class="frame-inner-wrap_01">
										...
										<div class="frame-inner-wrap_02">
											<div class="frame-inner-wrap_03">
												...
												if($new_radio_greetings=='new_product_promo' && class_exists('WooCommerce') && isset($product_res))
												{ 
