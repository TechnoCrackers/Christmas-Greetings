	...
	function cristmas_gift()
	{
		...
		if($radio_active=="active")
		{
			...
			{	
				...
				wp_enqueue_script('myjs2', $path.'js/cristmas.js');
				...
				if($tc_snow_radio=='enable')
				{
					if($radio_snow=='light')
					{
						wp_enqueue_script('myjs3', $path.'js/snowstorm.js');
					}
					else
					{
					 	if($radio_snow=='dark')
						...
						wp_enqueue_script('myjs3', $path.'js/snow01.js');
					}					
				}
					...
					{   echo '		
						<div id="div2" style="display:'.$preview_gift_tc.'">
							...
							<div class="message-box-part">
								<div class="tree-prt">
									<div class="tree-img img01">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img02">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img03">
										<img src="'.$path.'img/sonw-flex-b.png"/>
									</div>
									<div class="tree-img img04">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img05">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img06">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img07">
										<img src="'.$path.'img/sonw-flex-b.png"/>
									</div>
									<div class="tree-img img08">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img09">
										<img src="'.$path.'img/sonw-flex-b.png"/>
									</div>
									<div class="tree-img img10">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img11">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img12">
										<img src="'.$path.'img/sonw-flex-b.png"/>
									</div>
									<div class="tree-img img13">
										<img src="'.$path.'img/sonw-flex-b.png"/>
									</div>
									<div class="tree-img img14">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
									<div class="tree-img img15">
										<img src="'.$path.'img/sonw-flex-b.png"/>
									</div>
									<div class="tree-img img16">
										<img src="'.$path.'img/sonw-flex-a.png"/>
									</div>
								</div>
								<div class="circle-wrap">
									<img class="cr01" src="'.$path.'img/glow-b.png"/>
									<img class="cr02" src="'.$path.'img/glow-b.png"/>
									<img class="cr03" src="'.$path.'img/glow-b.png"/>
									<img class="cr04" src="'.$path.'img/glow-b.png"/>
									<img class="cr05" src="'.$path.'img/glow-b.png"/>
									<img class="cr06" src="'.$path.'img/glow-b.png"/>
									<img class="cr07" src="'.$path.'img/glow-b.png"/>
									<img class="cr08" src="'.$path.'img/glow-b.png"/>
									<img class="cr09" src="'.$path.'img/glow-b.png"/>
									<img class="cr10" src="'.$path.'img/glow-b.png"/>
									<img class="cr11" src="'.$path.'img/glow-b.png"/>
									<img class="cr12" src="'.$path.'img/glow-b.png"/>
									<img class="cr13" src="'.$path.'img/glow-b.png"/>
									<img class="cr14" src="'.$path.'img/glow-b.png"/>
									<img class="cr15" src="'.$path.'img/glow-b.png"/>
									<img class="cr16" src="'.$path.'img/glow-b.png"/>
									<img class="cr17" src="'.$path.'img/glow-b.png"/>
									<img class="cr18" src="'.$path.'img/glow-b.png"/>
									<img class="cr19" src="'.$path.'img/glow-b.png"/>
									<img class="cr20" src="'.$path.'img/glow-b.png"/>
									<img class="cr21" src="'.$path.'img/glow-b.png"/>
									<img class="cr22" src="'.$path.'img/glow-b.png"/>
									<img class="cr23" src="'.$path.'img/glow-b.png"/>
									<img class="cr24" src="'.$path.'img/glow-b.png"/>
									<img class="cr25" src="'.$path.'img/glow-b.png"/>
									<img class="cr26" src="'.$path.'img/glow-b.png"/>
									<img class="cr27" src="'.$path.'img/glow-b.png"/>
									<img class="cr28" src="'.$path.'img/glow-b.png"/>
									<img class="cr29" src="'.$path.'img/glow-b.png"/>
								</div>
								<div class="baloon-prt">
									<div class="baloon baloon-left">
										<img src="'.$path.'img/baloon.png"/>
									</div>
									<div class="glow left-glow">
										<img src="'.$path.'img/glow.png"/>
									</div>
									<div class="baloon baloon-right">
										<img src="'.$path.'img/baloon.png"/>
									</div>
									<div class="glow right-glow">
										<img src="'.$path.'img/glow.png"/>
									</div>
								</div>		
								<div class="frame-content">
									<div class="frame-inner-wrap">
										<div class="frame-inner-wrap01">
											...
											<ul class="button_01 hide-option ';if($radio_greetings=='coupon'){ echo "show-option";	} echo'" >
												<li>
												...
												<li>
													<div class="grab-style2">
														<a id="grab_text" href="#">grab it</a>
													</div> 
												</li>
											</ul>';
											if($radio_greetings=='product_promo' && class_exists('WooCommerce') && isset($product_res))
											{ 
												...
												while ( $the_query->have_posts() ) : $the_query->the_post();
														...
														echo '
															<div class="contain">
														  		<div class="card">
																	...
																	<div class="img_01"><img src="'.$featured_img_url.'"/></div>
																	<p><a href="#">'.get_the_title().'</a></p>
														 	 	</div>											
															</div>											
															<div class="addtocart">
																<a id="buy_'.get_the_ID().'" href="'.get_site_url().'/?add-to-cart='.get_the_ID().'" class="button">Add To Cart</a>
															</div>';			
													} 
													...
													{ 
														echo '<div class="li01">
															...
															<div class="button12">
																<aid="buy_'.get_the_ID().'" href="'.get_site_url().'/?add-to-cart='.get_the_ID().'" class="button">Add To Cart</a>
															</div>';
													}
